package com.collengine.sulu.tic_tac_toe;
...
import static com.collengine.sulu.tic_tac_toe.R.string.sucessful;

public class MegaSinglePlayerActivity extends AppCompatActivity implements View.OnClickListener {
...
//        }
    ...
    private void draw() {
        Toast.makeText(MegaSinglePlayerActivity.this, "Draw!", Toast.LENGTH_LONG).show();
        resetBoard();
    }

    private void player1Wins() {
        player1Points++;
        Toast.makeText(MegaSinglePlayerActivity.this, "Playe 1 wins!", Toast.LENGTH_LONG).show();
        updatePointsText();
        resetBoard();
    }
    ...
    private void player2Wins() {
        player2Points++;
        Toast.makeText(MegaSinglePlayerActivity.this, "Playe 2 wins!", Toast.LENGTH_LONG).show();
        updatePointsText();
        resetBoard();
    }
    ...
    private void updatePointsText() {
        ...
        tvPlayer2.setText("Player 1: "+ player2Points);
    ...
    private boolean checkForWinner(){
        ...
        //inspect the top bottom diagonal
