...
public class MegaTwoPlayerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mega_two_player);
    ...
    private void draw() {
        Toast.makeText(MegaTwoPlayerActivity.this, "Draw!", Toast.LENGTH_LONG).show();
        resetBoard();
    }

    private void player1Wins() {
        player1Points++;
        Toast.makeText(MegaTwoPlayerActivity.this, "Playe 1 wins!", Toast.LENGTH_LONG).show();
        updatePointsText();
        resetBoard();
    }
    ...
    private void player2Wins() {
        player2Points++;
        Toast.makeText(MegaTwoPlayerActivity.this, "Playe 2 wins!", Toast.LENGTH_LONG).show();
        updatePointsText();
        resetBoard();
    }
