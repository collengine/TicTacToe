...
//        }
    ...
    private void player1Wins() {
        player1Points++;
        Toast.makeText(SinglePlayerActivity.this, "Playe 1 wins!", Toast.LENGTH_LONG).show();
        updatePointsText();
        resetBoard();
    }
    ...
    private void player2Wins() {
        player2Points++;
        Toast.makeText(SinglePlayerActivity.this, "Playe 2 wins!", Toast.LENGTH_LONG).show();
        updatePointsText();
        resetBoard();
    }
